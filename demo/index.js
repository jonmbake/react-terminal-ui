    ...
    ***************************************************************************** */
    ...
    var Terminal = function (_a) {
        ...
        var renderedLineData = lineData.map(function (ld, i) {
            ...
            if (lineData.length === i + 1 && onInput == null) {
                return (React__default["default"].createElement("div", { className: classes.join(' '), key: i, ref: lastLineRef }, ld.value));
            }
            else {
                return (React__default["default"].createElement("div", { className: classes.join(' '), key: i }, ld.value));
            }
        });
        // render prompt
        if (onInput != null) {
            renderedLineData.push(React__default["default"].createElement("div", { className: "react-terminal-line react-terminal-input react-terminal-active-input", "data-terminal-prompt": prompt || '$', key: lineData.length, ref: lastLineRef }, currentLineInput));
        }
        var classes = ['react-terminal-wrapper'];
        if (colorMode === ColorMode.Light) {
            classes.push('react-terminal-light');
        }
        return (React__default["default"].createElement("div", { className: classes.join(' '), "data-terminal-name": name },
            React__default["default"].createElement("div", { className: "react-terminal" }, renderedLineData),
            React__default["default"].createElement("input", { className: "terminal-hidden-input", placeholder: "Terminal Hidden Input", value: currentLineInput, autoFocus: onInput != null, onChange: updateCurrentLineInput, onKeyDown: handleEnter })));
    };
    ...
    var TerminalController = function (props) {
        ...
        return (React__default["default"].createElement("div", { className: "container" },
            React__default["default"].createElement("div", { className: "d-flex flex-row-reverse p-2" },
                React__default["default"].createElement("button", { className: btnClasses.join(' '), onClick: toggleColorMode },
                    "Enable ",
                    colorMode === ColorMode.Light ? 'Dark' : 'Light',
                    " Mode")),
            React__default["default"].createElement(Terminal, { name: 'React Terminal UI', colorMode: colorMode, lineData: lineData, onInput: onInput })));
    };
    ReactDOM__default["default"].render(React__default["default"].createElement(React__default["default"].StrictMode, null,
        React__default["default"].createElement(TerminalController, null)), document.getElementById('terminal'));
